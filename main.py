...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def verify(self, list, domain):
        ...
        for email in list:
            ...
            #Ahhhhh ich muss mir noch was überlegen, damit man eine falsche Domain
                # eingeben kann, ohne dass das ganze Programm abschmirt
    ...
    def onExport(self):
        ...
        rows = self.ui.tableWidget.rowCount()
        for i in range(0, rows):
            worksheet.write(i+1,0,self.ui.tableWidget.item(i, 0).text())
            worksheet.write(i+1,1,self.ui.tableWidget.item(i, 1).text())
            worksheet.write(i+1,2,self.ui.tableWidget.item(i, 2).text())
            worksheet.write(i+1,3,self.ui.tableWidget.item(i, 3).text())
            worksheet.write(i+1,4,self.ui.tableWidget.item(i, 4).text())
            worksheet.write(i+1,5,self.ui.tableWidget.item(i, 5).text())
            worksheet.write(i+1,6,self.ui.tableWidget.item(i, 6).text())
            worksheet.write(i+1,7,self.ui.tableWidget.item(i, 7).text())
            worksheet.write(i+1,8,self.ui.tableWidget.item(i, 8).text())
            worksheet.write(i+1,9,self.ui.tableWidget.item(i, 9).text())
